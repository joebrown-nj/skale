...
<form action="/post-lead-form" method="POST" class="ajaxForm" id="lead-form" data-meta-form-name="task-management-migration-form" data-meta-success-event="Lead">
    ...
    <div class="mb-4">
        ...
        <textarea id="comment" name="comment" class="form-control" placeholder="{$textAreaPlaceholder || "Tell us what you want to improve..."}"></textarea>
    </div>
