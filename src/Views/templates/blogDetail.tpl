...
<section class="cta-section py-5 pb-0">
    <div class="bg-primary border-0 p-5 text-center">
        ...
        <div class="d-flex justify-content-center gap-3">
            <a href="/contact" class="mbtn btn btn-light btn-lg" aria-label="Book a Free Call">Book a Free Call</a>
            <a href="/solutions" class="mbtn btn btn-outline-light btn-lg" aria-label="Explore Solutions">Explore Solutions</a>
        </div>
    </div>
</section>
