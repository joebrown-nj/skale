    ...
    <div class="container py-5">
        <div class="row justify-content-center text-center mb-5">
            <div class="col-lg-8">
                ...
                <h2 class="display-6 fw-bold mt-2 text-dark">Most Businesses Add More Tools. We Make the Tools Work Together.</h2>
...
<section class="py-5 bg-automation-soft">
    <div class="container py-5">
        <div class="text-center mb-5">
            ...
            <h2 class="display-6 fw-bold mt-2 text-secondary">Simple. Strategic. Built Around Your Business.</h2>
        </div>
