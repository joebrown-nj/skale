<div class="glass-card" data-aos="fade-up">
    ...
    <form
    method="post"
    action="{$smarty.ENV.SITE_URL}"
    id="goals-form"
    class="ajaxForm"
    data-meta-form-name="home-growth-plan-form"
    data-meta-success-event="Lead"
    data-meta-success-custom-event="GrowthPlanSubmitted"
    data-meta-start-custom-event="GrowthPlanStarted"
    >
