...
<title>Website Design & Development That Drives Business | Skale</title>
<meta
name="description"
content="Your website should generate opportunities, not just traffic. Get a free website conversion review and discover what may be preventing visitors from contacting your business."
/>
...
<body>
<!-- =============================== MINIMAL HEADER ================================ -->
<!-- Deliberately avoids normal site navigation. -->
<header class="landing-header">
<div class="container">
<div class="d-flex justify-content-between align-items-center">
<a href="https://skaleup.it.com/" class="brand"> skale<span class="brand-dot">.</span> </a>

<div class="d-none d-sm-flex align-items-center gap-2">
<span class="small text-secondary">Prefer to talk?</span>
<a href="tel:+17329254044" class="header-phone">
...
<style>
    :root {
    --skale-green: #7ac943;
    --skale-green-dark: #559d25;
    --skale-green-light: #eef8e8;
    --skale-black: #101310;
    --skale-dark: #171b18;
    --skale-gray: #626a63;
    --skale-light: #f6f8f5;
    ...
    .text-green {
    color: var(--skale-green-dark) !important;
    }

    .bg-soft {
    background: var(--skale-light);
    }

    .bg-dark-custom {
    background: var(--skale-dark);
    }
    ...
    */
    .btn-skale {
    background: var(--skale-green);
    border: 2px solid var(--skale-green);
    color: #101310;
    border-radius: 7px;
    padding: 14px 24px;
    font-size: 1rem;
    ...
    .btn-skale:hover,
    .btn-skale:focus {
    background: var(--skale-green-dark);
    border-color: var(--skale-green-dark);
    color: #fff;
    transform: translateY(-1px);
    }

    .btn-outline-dark-custom {
    border: 2px solid var(--skale-black);
    color: var(--skale-black);
    border-radius: 7px;
    padding: 13px 24px;
    font-weight: 700;
    ...
    */
    ...
    overflow: hidden;
    padding: 80px 0 90px;
    background: radial-gradient(circle at 10% 15%, rgba(122, 201, 67, 0.13), transparent 28%),
    radial-gradient(circle at 85% 90%, rgba(122, 201, 67, 0.1), transparent 25%),
    ...
    */
    ...
    padding: 32px;
    border-radius: 14px;
    border: 1px solid var(--skale-border);
    box-shadow: 0 24px 70px rgba(22, 33, 24, 0.11);
    }
    ...
    border-color: var(--skale-green);
    box-shadow: 0 0 0 0.2rem rgba(122, 201, 67, 0.15);
    }
    ...
    */
    .proof-bar {
    border-top: 1px solid var(--skale-border);
    border-bottom: 1px solid var(--skale-border);
    }
    ...
    */
    ...
    margin-bottom: 22px;
    border-radius: 8px;
    background: var(--skale-green-light);
    color: var(--skale-green-dark);
    font-size: 1.3rem;
    }

    /*
    * Diagnostic / report visual
    */
    .report-shell {
    position: relative;
    background: var(--skale-dark);
    ...
    width: 82px;
    height: 82px;
    border: 8px solid var(--skale-green);
    border-radius: 50%;
    font-weight: 800;
    font-size: 1.45rem;
    }
